...
{
	const GLfloat near_plane = 1.0f, far_plane = 18.0f;
	glm::mat4 lightProjection = glm::ortho(-14.0f, 14.0f, -14.0f, 14.0f, near_plane, far_plane);
...
void initModels()
{
	...
	myModel2 = gps::Model3D("objects/island/untitled.obj", "objects/island/");
...
void renderScene()
{
	...
	//create model matrix for ground
	model = glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, -1000.0f, -1000.0f));
	//send model matrix data to shader
	glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
